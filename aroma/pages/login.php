			...
			<div class="blog-banner">
				<div class="text-center">
					...
					<nav aria-label="breadcrumb" class="banner-breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="/0155/">Главная</a></li>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							<h4>Вы впервые посещаете наш сайт?</h4>
							<p>Чтобы войти в личный кабинет, необходимо зарегистрироваться.</p>
							<a class="button button-account" href="/0155/register">Зарегистрируйтесь!</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
